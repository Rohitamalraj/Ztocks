...
const metrics = [
  { value: 7.4, suffix: "B", prefix: "$", label: "Decentralized identity market 2026" },
  { value: 1500000, suffix: "+", prefix: "", label: "ZK credentials issued (zkMe)" },
  { value: 85, suffix: "/117", prefix: "", label: "Jurisdictions with FATF Travel Rule" },
  { value: 4, suffix: " tiers", prefix: "", label: "ZK-governed leverage caps" },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-16 lg:mb-24">
          ...
          <div className="flex items-center gap-4 font-mono text-sm text-muted-foreground">
            ...
            {mounted && <span>{time.toLocaleTimeString()}</span>}
          </div>
        </div>
